import MainIpleImage from '../../../assets/iple.webp'
import Thumb1 from '../../../assets/iple-right.webp'
import Thumb2 from '../../../assets/iple-left.webp'
import DimensionesImage from '../../../assets/iple-dim.webp'
import { useState } from 'react'

export default function MainIple() {
    // const imageList = [MainIpleImage, Thumb1, Thumb2];
    // const [index, setIndex] = useState(0);

    // const goRight = () => {
    //     setIndex((indice) => (indice === imageList.length - 1 ? 0 : indice + 1))

    // }
    // const goLeft = () => {
    //     setIndex((indice) => (indice === 0 ? imageList.length - 1 : indice - 1))
    // }
    ...
    return (
        <section className="w-full max-w-[90%] mx-auto overflow-hidden space-y-5">
            ...
            {/* Header / Título */}
            <header className="w-full font-sans text-orange-500 space-y-5">
            ...
            {/* <div className="flex flex-col items-center gap-4 w-full">
                <div className="relative flex justify-center items-center w-full max-w-3xl">
                    ...
                    <button
                        onClick={goLeft}
                        className="absolute left-[-250px] px-6 py-4 bg-orange-600 text-white text-2xl rounded-full"
                    >
                        {"<"}
                    </button>
                    <button
                        onClick={goRight}
                        className="absolute right-[-250px] px-6 py-4 bg-orange-600 text-white text-2xl rounded-full"
                    >
                        {">"}
                    </button>
                </div>
                ...
                <div className='md:w-[500px] w-[200px] h-full max-h-[600px] transform-3d flex justify-center items-center'>
                    ...
                    <div className="cards relative w-full h-full">
                        <label
                            htmlFor="item-1"
                            id='selector-1'
                            className={`card scale-125`}
                        >
                            <img src={MainIpleImage} alt="Imagen 1" className="w-full h-full object-contain rounded" />
                        </label>
                    ...
                    <table className="border border-orange-500 border-collapse font-sans">
                        <tbody>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td className="p-2">Fusible interno de protección</td>
                                    <td className="p-2"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td className="p-2">Estructura metálica de plancha galvanizada protección IK10</td>
                                </tr>
                                <tr>
                                    <td className="p-2">Ángulo de iluminación 60°</td>
                                    <td className="p-2">Dimensiones 28.5 x 26 x 11 cm (incluyendo los faros)</td>
                                </tr>
                                <tr>
                                    <td className="p-2">Temperatura de color 6500K</td>
                                    <td className="p-2">Pintura electrostática texturizada y secada al horno</td>
                                </tr>
                                <tr>
